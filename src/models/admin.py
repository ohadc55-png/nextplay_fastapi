...
class AdminTask(Base):
    ...
    status: Mapped[str | None] = mapped_column(Text, nullable=True, server_default="backlog")
    priority: Mapped[str | None] = mapped_column(Text, nullable=True, server_default="medium")
